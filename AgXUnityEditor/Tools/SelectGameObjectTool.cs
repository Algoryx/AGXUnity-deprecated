...
namespace AgXUnityEditor.Tools
{
  public class SelectGameObjectTool : Tool
  {
    ...
    private GUIContent WindowTitle { get { return Utils.GUI.MakeLabel( "Select game object" ); } }
    ...
    public override void OnSceneViewGUI( SceneView sceneView )
    {
      ...
      if ( clickAndMiss )
        ...
        float buttonMaxWidth = Mathf.Max( 1.5f * Utils.GUI.Skin.label.CalcSize( WindowTitle ).x, Utils.GUI.Skin.button.CalcSize( GetGUIContent( Manager.MouseOverObject ) ).x );
        ...
        if ( Manager.MouseOverObject != null ) {
          ...
          while ( parent != null ) {
            buttonMaxWidth = Mathf.Max( buttonMaxWidth, Utils.GUI.Skin.button.CalcSize( GetGUIContent( parent.gameObject ) ).x );
